...
export default class Search {
    ...
    renderResultsHTML(events) {
      ...
      ${events
          ...
          .map((item) => {
              let eventsDate = new Date(events.created_at);
              return `<a href="/event/${item.id}" class="list-group-item list-group-item-action"  <strong>${item.title}</strong>
